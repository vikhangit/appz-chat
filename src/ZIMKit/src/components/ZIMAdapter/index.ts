...
export class ZIMAdapter {
  ...
  sendGroupMessage(
    ...
    return ZIMAdapter.getInstance().sendGroupMessage(
      message,
      toGroupID,
      config
    );
  ...
  sendMediaMessage(
    ...
    return ZIMAdapter.getInstance().sendMediaMessage(
      message,
      toConversationID,
      conversationType,
      config,
  ...
  queryHistoryMessage(
    ...
    return ZIMAdapter.getInstance().queryHistoryMessage(
      conversationID,
      conversationType,
      config
    );
  ...
  deleteMessages(
    ...
    return ZIMAdapter.getInstance().deleteMessages(
      messageList,
      conversationID,
      conversationType,
      config
  ...
  deleteConversation(
    ...
    return ZIMAdapter.getInstance().deleteConversation(
      conversationID,
      conversationType,
      config
    );
  ...
  clearConversationUnreadMessageCount(
    ...
    return ZIMAdapter.getInstance().clearConversationUnreadMessageCount(
      conversationID,
      conversationType
    );
  }
